...
const STRINGS = {
    hi: {
       ...
       'alert.bandhanaPunyaShesha.subtitle': '{n} शेष — नाम-जाप जारी रखें।',
        ...
        'alert.errNaamaAbsent.title': 'नाम संग्रह नहीं',
    ...
    en: {
        ...
        'alert.errNaamaAbsent.title': 'Naama sanchit absent',
        ...
        'gyro.switchTouch': 'Touch Steering',
