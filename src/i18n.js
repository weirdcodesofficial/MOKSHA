...
const STRINGS = {
    hi: {
        ...
        'start.tutorialButton': '🕉️ गुरु-दीक्षा देखें',
        ...
        'alert.drishtiJyoti.subtitle': 'B दबाएँ — ज्योति से अंधकार भगाएँ।',
        'alert.drishtiNone.subtitle': 'ज्योति संग्रह करें — पाप का अंधकार बढ़ा।',
        'alert.prarabdhaBhoga.title': 'एक प्रारब्ध भोग लिया',
        'alert.prarabdhaBhoga.subtitle': '{n} शेष।',
        'alert.prarabdhaMukta.title': 'प्रारब्ध से मुक्ति',
        'alert.prarabdhaMukta.subtitle': 'पूर्ण भोग संपन्न!',
       ...
       'alert.bandhanaPunyaShesha.subtitle': '{n} शेष — नाम-जाप जारी रखें।',
        ...
        'alert.errJyotiAbsent.title': 'ज्योति-शक्ति समाप्त',
        'alert.errJyotiAbsent.subtitle': 'पहले ज्योति संग्रह करें।',
        ...
        'alert.errPrarabdhaMax.title': 'प्रारब्ध सीमा',
        'alert.errPrarabdhaMax.subtitle': 'अधिकतम {n} — नया बोझ असंभव।',              
        // ── पुनर्जन्म ──
        ...
        'tutorial.prarabdha.credit': '— स्कन्द पुराण',
        'tutorial.prarabdha.meaning': '',
        'tutorial.prarabdha.task': 'प्रारब्ध भोगना ही पड़ता है — टाला नहीं जा सकता।\nमृत्यु पर प्रारब्ध +१ जुड़ता है। धैर्य रखो।\n\n"ENTER" दबाओ — यात्रा शुरू हो!',
        'tutorial.prarabdha.hint': 'पुण्य, नाम, और समर्पण से मोक्ष मिलता है।',
    ...
    en: {
        ...
        'start.tutorialButton': '🕉️ View Guru-diksha',
        ...
        'alert.samaya100Tunnel.subtitle': 'Press W — offer Nāma-Samarpaṇa!',
        ...
        'alert.samaya100NoNaam.subtitle': 'No Nāma collected — gather ॐ!',
        'alert.chetana.title': 'Chetanā awakened!',
        'alert.chetana.subtitle': 'The charioteer has seen through Māyā.',
        ...
        'alert.samarpita50.subtitle': 'Remarkable! Moving toward complete Vairāgya.',
        'alert.chakravaata.title': 'Chakravāta (storm) near',
        'alert.chakravaataShankha.subtitle': 'Press Y — destroy it with the Śaṅkha!',
        'alert.chakravaataNone.subtitle': 'Gather a Śaṅkha — you are unprotected.',
        'alert.drishti.title': 'Vision obscured',
        'alert.drishtiJyoti.subtitle': 'Press B — dispel the dark with Jyoti.',
        'alert.drishtiNone.subtitle': 'Gather Jyoti — the dark of Pāpa is growing.',
        'alert.prarabdhaBhoga.title': 'One Prārabdha endured',
        'alert.prarabdhaBhoga.subtitle': '{n} remaining.',
        'alert.prarabdhaMukta.title': 'Freed from Prārabdha',
        'alert.prarabdhaMukta.subtitle': 'The enduring is complete!',
        ...
        'alert.bandhanaPunyaMukta.title': 'Freed from Puṇya-bondage',
        'alert.bandhanaPunyaMukta.subtitle': 'Good karma burnt — the mind is clear.',
        'alert.bandhanaPunyaShesha.title': 'Puṇya-bondage',
        'alert.bandhanaPunyaShesha.subtitle': '{n} remaining — keep chanting the Nāma.',
        'alert.bandhanaPaapaMukta.title': 'Freed from Pāpa-bondage',
        'alert.bandhanaPaapaMukta.subtitle': 'Inauspicious karma burnt — the soul is pure.',
        'alert.bandhanaPaapaShesha.title': 'Pāpa-bondage',
        'alert.bandhanaPaapaShesha.subtitle': '{n} remaining — 5 more Nāma needed.',
        'alert.kripaSamarpita.title': 'Kṛpā (grace)',
        'alert.kripaSamarpita.subtitle': 'All worldly Puṇya and Pāpa have been surrendered.',
        'alert.kripaSimple.title': 'Kṛpā received',
        'alert.kripaSimple.subtitle': '',  
        'alert.shankhaPrapta.title': 'Śaṅkha (conch) received',
        'alert.jyotiPrapta.title': 'Jyoti (lamp) received',
        'alert.shankhaPrapta.subtitle': 'Keep it safe — it quells the Chakravāta.',
        'alert.jyotiPrapta.subtitle': 'Press B to spread light in the darkness.',         
        'alert.errNaamaAbsent.title': 'Cannot chant',
        'alert.errNaamaAbsent.subtitle': 'Nāma-Japa requires collected Nāma!',
        'alert.errShankhaAbsent.title': 'No Śaṅkha left',
        'alert.errShankhaAbsent.subtitle': 'Gather a Śaṅkha first.',
        'alert.errJyotiAbsent.title': 'No Jyoti left',
        'alert.errJyotiAbsent.subtitle': 'Gather a Jyoti first.',
        'alert.errSamarpanaPhase.title': 'Samarpaṇa refused',
        'alert.errSamarpanaPhase.subtitle': 'Nāma-Samarpaṇa is possible only in the final phase.',
        'alert.errSamarpanaNoNaam.title': 'Samarpaṇa refused',
        'alert.errSamarpanaNoNaam.subtitle': 'No Nāma left to surrender.',
        'alert.errSamarpanaTunnel.title': 'Samarpaṇa refused',
        'alert.errSamarpanaTunnel.subtitle': 'You must be inside the Bhakti path to surrender the Nāma.',
        'alert.errPrarabdhaMax.title': 'Prārabdha limit',
        'alert.errPrarabdhaMax.subtitle': 'Maximum {n} — no further burden possible.',        

        // ── Rebirth ──
        'alert.punarjanmaApavitra.title': 'Impure Punarjanma',
        'alert.punarjanmaApavitra.subtitle': 'Karma remained unbalanced; the cycle continues...',
        'alert.punarjanmaPavitra.title': 'Pure Punarjanma',
        'alert.punarjanmaPavitra.subtitle': 'Karma was pure, but the journey stayed unfinished.',
        'alert.punarjanmaNaya.title': 'Pure Punarjanma',
        'alert.punarjanmaNaya.subtitle': 'A new journey begins.',
        'alert.kripaAtirikta.title': 'Extra Kṛpā',
        'alert.kripaAtirikta.subtitle': 'Entering the new life carrying Kṛpā!',

        // ── Actions ──
        'alert.naamaSumirana.title': 'Nāma-Sumirana',
        'alert.naamaSumirana.subtitle': 'Purifying...',
        'alert.vikshepa.title': 'Vikṣepa (disturbance)',
        'alert.vikshepa.subtitle': 'The Chakravāta shook the chariot!',
        'alert.paapaPrapta.title': 'Pāpa gained',
        'alert.paapaPrapta.subtitle': 'The strike of inauspicious karma!',
        'alert.punyaPrapta.title': 'Puṇya gained',
        'alert.punyaPrapta.subtitle': "The charioteer's mind accepted good deeds.",
        'alert.naamaSamarpita.title': 'Nāma surrendered',
        'alert.naamaSamarpita.subtitle': '+{n} received.',
        'alert.vairaagya.title': 'Vairāgya (detachment)',
        'alert.vairaagya.subtitle': 'The charioteer refused the lure of Puṇya.',
        'alert.shankhaNaada.title': 'Śaṅkha-nāda',
        'alert.shankhaNaada.subtitle': 'White light is spreading...',
        'alert.shankhaChakra.title': 'Śaṅkha-nāda',
        'alert.shankhaChakra.subtitle': 'The Chakravāta was surrendered.',
        'alert.jyotiJali.title': 'Jyoti lit',
        'alert.jyotiJali.subtitle': 'Light is spreading in the dark of Pāpa...',
        ...
        'tutorial.move.credit': '— Bhagavad Gītā 6.5',
        ...
        'tutorial.maya.credit': '— Yogavāsiṣṭha',
        'tutorial.maya.meaning': 'This universe is a net of Māyā; it deludes the entire world.',
        ...
        'tutorial.tunnel.credit': '— Bhagavad Gītā 18.55',
        ...
        'tutorial.tunnel.hint': 'Nāma-Samarpaṇa (↑) is possible within the Bhakti path.',

        'tutorial.prarabdha.credit': '— Skanda Purāṇa',
        'tutorial.prarabdha.meaning': 'Pāpa wanes through enduring; impurity wanes through tapas.',
        'tutorial.prarabdha.task': 'Prārabdha must be endured — it cannot be avoided.\nOn death, Prārabdha increases by 1. Be patient.\n\nPress "ENTER" — let the journey begin!',
        'tutorial.prarabdha.hint': 'Moksha comes through Puṇya, Nāma, and Samarpaṇa.',        

        // ── End screens ──
        'end.pralaya.title': '🛑 PRALAYA 🛑',
        'end.pralaya.lead': 'Journey abandoned:',
        'end.pralaya.line1': 'The charioteer let go of the chariot midway.',
        'end.pralaya.stats': 'State of mind — Puṇya: {punya} | Pāpa: {paap}',
        ...
        'end.moksha.line1': 'You need not be born again. This world is a net of Māyā, and from it you have at last found release.',
        'end.moksha.line2': 'You have won this game of birth and death.',
        'end.moksha.heading': 'Beyond the guṇas and beyond karma',
        ...
        'end.rebirth.title': 'Punarjanma in the world',
        'end.rebirth.lead': 'The reins of Moha (delusion):',
        'end.rebirth.paap': 'Your ({n}) Pāpa blinded the charioteer.',
