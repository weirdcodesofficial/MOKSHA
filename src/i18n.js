...
const STRINGS = {
    hi: {
        ...
        'viraama.quit':    'छोड़ें',
        'shastra.title':   '॥ शास्त्र ॥',
        'shastra.subtitle':'रथ का ज्ञान',
    ...
    en: {
        ...
        'viraama.resume':  'Resume',
        'viraama.restart': 'Restart',
        'viraama.quit':    'Quit',
        'shastra.title':   '॥ Shaastra ॥',
        'shastra.subtitle':'Knowledge of the Chariot',
        'tutorial.dismiss':'ENTER / TAP to continue',
        ...
        'alert.samarpita50.subtitle': 'Remarkable! Moving toward complete Vairagya.',
        ...
        'alert.drishtiNone.subtitle': 'Gather Jyoti — the dark of Papa is growing.',
        'alert.prarabdhaBhoga.title': 'One Prarabdha endured',
        'alert.prarabdhaBhoga.subtitle': '{n} remaining.',
        'alert.prarabdhaMukta.title': 'Freed from Prarabdha',
        ...
        'alert.kripaSamarpita.title': 'Kripa (grace)',
        'alert.kripaSamarpita.subtitle': 'All worldly Punya and Papa have been surrendered.',
        'alert.kripaSimple.title': 'Kripa received',
        'alert.kripaSimple.subtitle': '',  
        'alert.shankhaPrapta.title': 'Shankha (conch) received',
        ...
        'alert.errPrarabdhaMax.title': 'Prarabdha limit',
        ...
        'alert.kripaAtirikta.title': 'Extra Kripa',
        'alert.kripaAtirikta.subtitle': 'Entering the new life carrying Kripa!',
        ...
        'alert.naamaSamarpita.title': 'Naama surrendered',
        'alert.naamaSamarpita.subtitle': '+{n} received.',
        'alert.vairaagya.title': 'Vairagya (detachment)',
        ...
        'tutorial.jaapa.meaning': 'By chanting the Naama, auspiciousness arises in all ten directions.',
        ...
        'tutorial.prarabdha.credit': '— Skanda Purana',
        'tutorial.prarabdha.meaning': 'Papa wanes through enduring; impurity wanes through tapas.',
        'tutorial.prarabdha.task': 'Prarabdha must be endured — it cannot be avoided.\nOn death, Prarabdha increases by 1. Be patient.\n\nPress "ENTER" — let the journey begin!',
        'tutorial.prarabdha.hint': 'Moksha comes through Punya, Naama, and Samarpana.',        
        ...
        'hud.prarabdhaTimerLabel': 'Prarabdha {n} remaining',
        // ── notify overlay ──
